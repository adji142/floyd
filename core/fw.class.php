...
class FloydWarshall {
    ...
    public function print_graph() {
        ...
        if (empty($_SERVER['argv'])) {
            echo '<h3>Graph</h3>';
            echo '<table class="table datatable table-striped table-condensed table-bordered table-hover">';
            if (!empty($this->nodenames)) {
                echo '<thead><tr>';
                echo '<th class="text-center">Nodes</th>';
